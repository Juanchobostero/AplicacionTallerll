...
Public Class frmRegistro
    ...
    Private Sub txtEdad_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Char.IsNumber(e.KeyChar) Then
            e.Handled = False
        ElseIf Char.IsControl(e.KeyChar) Then
            e.Handled = False
    ...
    Public Sub btnRegistrarse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRegistrarse.Click
        ...
        If ask = MsgBoxResult.Yes Then
            ...
            Dim añoHoy As Integer = Year(Now)
            Dim añoNac As Integer = dtpFechaNacimiento.Value.Year
            Dim edad As Integer = añoHoy - añoNac
            ...
            Dim contraseña As String = txtContraseña.Text
                ...
                If (txtNombre.Text = String.Empty Or txtApellido.Text = String.Empty Or txtDNI.Text = String.Empty Or txtDireccion.Text = String.Empty Or txtTelefono.Text = String.Empty Or txtContraseña.Text = String.Empty Or txtRepetirContraseña.Text = String.Empty) Then
    ...
    Private Sub txtRepetirContraseña_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtRepetirContraseña.TextChanged
