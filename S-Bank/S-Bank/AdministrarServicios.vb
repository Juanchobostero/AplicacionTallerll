...
Public Class frmAdministrarServicios
        ...
        Else
            ...
            If ask = MsgBoxResult.Yes Then
                ...
                Else
                    ...
                    variableAux = MsgBox("Desea modificar el servicio cod_servicio: " & idServicioModificar & "?", 4 + 256 + 32, "Modificacion del Servicio")
                    If variableAux = MsgBoxResult.Yes Then
                        ...
                        Dim query As String = "UPDATE Servicios SET descripcion_servicio='" & descripcionServicio & "', monto_servicio='" & monto & "'  WHERE cod_servicio=" & idServicioModificar
                        ModuloConexion.SQL_Consulta(ModuloConexion.sqlConnection1, query)
                        ModuloConexion.sqlConnection1.Close()
    ...
    Private Sub AgregarTipoServicio_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla '_S_BankDataSet1.proveedores' Puede moverla o quitarla según sea necesario.
        Me.ProveedoresTableAdapter.Fill(Me._S_BankDataSet1.proveedores)
    ...
    Private Sub dgvTipoServicio_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoServicio.CellClick
    ...
    Private Sub dgvTipoServicio_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoServicio.CellContentClick
        ...
        If botonData IsNot Nothing Then
            ...
            If Me.dgvTipoServicio.Columns(e.ColumnIndex).Name = "Eliminar" Then
                ask = MsgBox("Desea eliminar este registro :" & descripcion1 & "?", 4 + 256 + 32, "Eliminacion de Registro")
                If ask = MsgBoxResult.Yes Then
                    ...
                    dtpVencimiento1.Enabled = False
                    dtpVencimiento2.Enabled = False
