...
Public Class frmNuevoTipoCuentaBancaria
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        ...
        Else
            ask = MsgBox("¿Seguro que desea agregar una nueva Cuenta?", 4 + 0 + 32, "Agregar")
        ...
        If ask = MsgBoxResult.Yes Then
            ...
            Else
                ...
                Else
                    ...
                    variableAux = MsgBox("Desea modificar el tipo de cuelta id_tipoCuenta: " & idCuentaModificar & "?", 4 + 256 + 32, "Modificacion del tipo de cuenta")
    ...
    Private Sub dgvTipoCuentas_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoCuentas.CellContentClick
        ...
        If botonData IsNot Nothing Then
            ...
            If Me.dgvTipoCuentas.Columns(e.ColumnIndex).Name = "Eliminar" Then
                ask = MsgBox("Desea eliminar el registro: " & descripcion1 & "?", 4 + 256 + 32, "Eliminacion de Registro")

                If ask = MsgBoxResult.Yes Then

                    If ModuloFunciones.ExisteTipoCuenta() Then

                        MsgBox("El tipo de cuenta no se puede eliminar por estar asociado a una cuenta, debe eliminar primero la cuenta", 0 + 0 + 16, "Error")
                    Else
