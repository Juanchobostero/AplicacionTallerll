Public Class frmAdministrarCuentas
    ...
    Private Sub dgvCuentas_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvCuentas.CellClick
        ...
        lblIDCuenta.Text = dgvCuentas.Item(0, i).Value()
        ...
        If botonData IsNot Nothing Then
            ...
            If Me.dgvCuentas.Columns(e.ColumnIndex).Name = "Eliminar" Then
                ...
                If ask = MsgBoxResult.Yes Then
                    ...
                    If ModuloFunciones.existeCuentaEnMovimiento() Then

                        MsgBox("Esta cuenta esta asociada a un movimiento, elimine primero el movimiento correspondiente", 0 + 0 + 16, "Error")

                    Else
                        If ModuloFunciones.existeCuentaEnFactura() Then

                            MsgBox("Esta cuenta esta asociada a una/s factura/s, elimine primero la factura correspondiente", 0 + 0 + 16, "Error")
    ...
    Private Sub TipoCuentaBindingSource_CurrentChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
