Public Class frmFormUsuario
    ...
    Private Sub FormularioUsuario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim nick3 As String = frmConsultarSaldo.lblNomUsuario.Text
        Dim nick4 As String = frmTransferencias.lblNomUsuario.Text

        If frmPagarServicios.banderaPS = 1 Then
        ...
        Else
            If frmConsultarSaldo.banderaCS = 2 Then
            ...
            ElseIf frmTransferencias.banderaT = 3 Then
    ...
    Private Sub btnSaldo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaldo.Click
        frmConsultarSaldo.Show()
        Me.Close()
    End Sub

    Private Sub btnMovimiento_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTransferencia.Click
