Public Class frmAdministrarProveedor
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        ...
        Else
            ask = MsgBox("¿Seguro que desea agregar un nuevo Proveedor?", 4 + 0 + 32, "Agregar")
        ...
        If ask = MsgBoxResult.Yes Then
            ...
            Else
                ...
                Else
                    ...
                    If (modificarRegistro = True) Then
                        'Modificar Proveedor
    ...
    Private Sub dgvProveedores_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvProveedores.CellClick
        ...
        txtDescripcionProveedor.Text = dgvProveedores.Item(1, i).Value()
            ...
            If Me.dgvProveedores.Columns(e.ColumnIndex).Name = "Eliminar" Then
                ...
                If ask = MsgBoxResult.Yes Then
                    If ModuloFunciones.Existe_proveedor() Then
                        MsgBox("El proveedor esta asociado a un servicio, asegurese de eliminar primero el servicio correspondiente", 0 + 0 + 16, "Error")
    ...
    Private Sub txtDescripcionProveedor_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtDescripcionProveedor.KeyPress
    ...
    Private Sub txtDescripcionProveedor_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDescripcionProveedor.TextChanged

        txtDescripcionProveedor.Text = System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(txtDescripcionProveedor.Text)
        txtDescripcionProveedor.SelectionStart = txtDescripcionProveedor.Text.Length
    End Sub
End Class